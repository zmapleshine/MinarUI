layui.define(['layer'], function (exports) {
    ...
    var $ = layui.$
        ...
        //字符常量
        , MOD_NAME = 'fupload', ELEM = '.layui-upload', THIS = 'layui-this', SHOW = 'layui-show', HIDE = 'layui-hide',
        ...
        var that = this
            ...
            , ajaxSend = function () {
                ...
                layui.each(items, function (index, file) {
                    ...
                    //追加额外的参数
                    layui.each(options.data, function (key, value) {
                        value = typeof value === 'function' ? value(file.name) : value;
                        ...
                        layui.use("COS", function () {
                            ...
                            var cos = new COS({
                                getAuthorization: function (option, callback) {
                                    callback({
                                        TmpSecretId: options.data.TmpSecretId,
                                        TmpSecretKey: options.data.TmpSecretKey,
                                        XCosSecurityToken: options.data.XCosSecurityToken,
                                        ExpiredTime: options.data.ExpiredTime
                                    });
                                }
                            });
                            cos.putObject({
                        ...
                        $.ajax({
                            ...
                            , xhr: function () {
                                ...
                                newXhr.upload.addEventListener('progress', function (e) {
                                    ...
                                    typeof options.progress === 'function' && options.progress(index, percent);
                                });
                                return newXhr;
                            }
                            , success: function (res) {
                                successful++;
                                done(index, res, formData, param);
                                allDone();
                            }
                            , error: function () {
                                aborted++;
            ...
            //统一回调
            , done = function (index, res, formData, param) {
