...
!function (a) {
    if (layui) {
        layui.define(function (exports) {
            layui.link(layui.cache.modules.wangeditor.replace(".min.js",".css"));
            exports("wangeditor",a($))
        });
        return;
    }
    "function" == typeof window.define ? window.define.amd ? window.define("wangEditor", ["jquery"], a) : window.define.cmd ? window.define(function (b, c, d) {
        return a
    }) : a(window.jQuery) : "object" == typeof module && "object" == typeof module.exports ? (require("wangeditor.css"), module.exports = a(require("jquery"))) : a(window.jQuery)
}(function (a) {
    ...
    return function (a, b) {
        if (a.wangEditor) console.error("一个页面不能重复引用 wangEditor.js 或 wangEditor.min.js ！！！");
        // if (a.wangEditor)return void console.error("一个页面不能重复引用 wangEditor.js 或 wangEditor.min.js ！！！");
        var c = function (a) {
            "string" == typeof a && (a = "#" + a);
            var c = b(a);
            if (1 === c.length) {
        ...
        a.createMenu(function (c) {
            ...
            if (c(d)) {
                ...
                j.append(k);
                var l = b('<div style="margin:20px 10px;"></div>'), m = b('<input type="text" value="100" style="width:50px;text-align:center;"/>'), n = b('<input type="text" value="498" style="width:50px;text-align:center;"/>');
                l.append("<span> " + f.width + " </span>").append(m).append("<span> % &nbsp;&nbsp;&nbsp;</span>").append("<span> " + f.height + " </span>").append(n).append("<span> px </span>");
        ...
        if (window.FileReader && window.FormData) {
            ...
            c.fn = c.prototype, c.fn.clear = function () {
                ...
                if (!c._hasRender) {
                    a.log("渲染dom");
                    var d = c.fileAccept, e = d ? 'accept="' + d + '"' : "", f = c.multiple, g = f ? 'multiple="multiple"' : "", h = b('<input type="file" ' + e + " " + g + "/>"), i = b('<div style="display:none;"></div>');
