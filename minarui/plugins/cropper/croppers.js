...
layui.define(['jquery','layer','cropper'],function (exports) {
    ...
    var html = 
        ...
        "                    <button type=\"button\" class=\"layui-btn layui-icon layui-icon-search\" title=\"放大图片\">放大图片</button>\n" +
        "                    <button type=\"button\" class=\"layui-btn layui-icon \" title=\"缩小图片\">缩小图片</button>\n" +
        "                    <button type=\"button\" class=\"layui-btn layui-icon layui-icon-refresh\" cropper-event=\"reset\" title=\"重置图片\"></button>\n" +
        "                </div>\n" +
        "            </div>\n" +
        "        </div>\n" +
        "        <div class=\"layui-col-xs3\">\n" +
        "            <button class=\"layui-btn \" cropper-event=\"confirmSave\" type=\"button\"> 保存修改</button>\n" +
        "        </div>\n" +
        "    </div>\n" +
        "\n" +
        "</div>";
